...
public class ModeService {
    ...
    private static final String MODE_KEY = "neosis:mode";
    private static final String MODE_DIR_KEY = "neosis:mode:bulk-dir";
    private static final String MODE_BULK_ACTIVE_KEY = "neosis:mode:bulk-active";
