...
import com.noesis.service.NoesisStateService;
...
public class DocumentIngestionService {
    ...
    public String processFileEvent(Path filePath) {
        ...
        String relativePath = noesisStateService.getRelativePathString(absolutePath);
        
        String lockKey = "noesis:lock:ingest:path:" + org.springframework.util.DigestUtils.md5DigestAsHex(absolutePath.getBytes(java.nio.charset.StandardCharsets.UTF_8));
